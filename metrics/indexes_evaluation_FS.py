...
"""
from metrics.pan_metrics.interp23 import interp23
...
"""
from metrics.pan_metrics.HQNR import HQNR


def indexes_evaluation_FS(I_F, I_MS_LR, I_PAN, th_values, I_MS, sensor, ratio, Qblocks_size, ret_dict=True):
    ...
    if ret_dict:
        return {'D_lambda': D_lambda, 'D_S': D_S, 'HQNR_index': HQNR_index}
    else:
        return D_lambda, D_S, HQNR_index
